...
|---|---|---|
| [Agent Project and Release Specification](/specification) | Canonical project roles, framework profiles, dependency locking, release closure, workspace scope, authority, evaluations, and migrations | Working Draft 0.1 |
...
1. **Agent Project and release conformance.** [Working Draft
   0.1](/specification) defines canonical roles, dependencies, release closure,
   and the minimum platform-facing contract while preserving framework-native
   projects.
