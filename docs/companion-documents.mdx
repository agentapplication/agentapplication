...
The first contract is now a working specification with its own change process,
defined in the specification itself. It will remain a draft until independent
framework and platform implementations test the boundary.
