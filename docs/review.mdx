...
sidebarTitle: "Review"
description: "How to send holes, counterexamples, boundary cases, and prior art for Working Draft 0.8."
---

This is **Working Draft 0.8**, and the work is now being developed in public at
...
The companion contracts are developed in the same repository. A contract is
ready to become a specification when independent implementations need a stable
boundary. See [Companion documents](/companion-documents) and the [Agent Project
and Release Specification](/specifications/agent-project-and-release) for the
current work.
