...
Framework profiles map these canonical roles to native layouts. Plugins remain
dependencies instead of copied application source, and the lockfile fixes their
exact content for a release. The [Agent Project and Release
Specification](/specifications/agent-project-and-release) defines this
contract.
