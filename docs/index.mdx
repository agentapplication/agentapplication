...
description: "Persistent, tool-using agents that keep work across sessions are a distinct application category."
mode: "default"
...
The [paper](/paper) is the architecture: the definition, the capability model,
the lifecycle, the security and governance view, and the open questions. It
includes [guided reading paths](/paper#guided-reading-paths) for application
developers, framework authors, platform operators, buyers, and standards
contributors.

## Contribute

The paper is a working draft. It is most useful if its boundaries survive
contact with real products.
...
[Read the review guide](/review) before sending a longer critique.
[CONTRIBUTING.md](https://github.com/agentapplication/agentapplication/blob/main/CONTRIBUTING.md)
explains how to prepare a pull request.
