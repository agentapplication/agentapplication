...
| Document | Purpose |
|---|---|
| The [Agent Applications Manifesto](https://agentapplication.io/manifesto) | A short public argument for software that does the work |
...
manifesto is published at
[agentapplication.io/manifesto](https://agentapplication.io/manifesto). The
