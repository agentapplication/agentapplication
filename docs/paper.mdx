...
[Karta](https://karta.sh/platform) is one implementation that provides
platform services at L5 and agent monetization capabilities at L6.
...
reflected in Appendix A's illustrative layout. Karta's [harness-selection
series](https://karta.sh/blog/harness-selection-part-5-recommendation) provides
one workload-based comparison of current harnesses for the selection step in
section 9.
...
first-party documentation. Karta's [executable capability
check](https://karta.sh/blog/harness-selection-part-2-capability-parity)
independently verifies MCP, Skills, hooks, subagents, code execution, shell
access, and web access across four of the five projects in the table.
...
debugger. The project was sunset in April 2026; section 11.2 cites it as early
