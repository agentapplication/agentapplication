...
A framework profile maps canonical application roles to those native files. It
also defines dependency loading, component identities, manifest and lockfile
validation, runtime feature names, and the harness versions it covers.
...
See [the paper](/paper), sections 3, 7, 9, and 24.2, and the [Agent Project and
Release Specification](/specifications/agent-project-and-release#8-framework-profiles).
